<div class="box featured">
	<div class="box-heading">
		<div class="customNavigation">
			<a class="prev2"><i class="fa fa-caret-left"></i></a>
			<a class="next2"><i class="fa fa-caret-right"></i></a>
		</div>
		<h3><?php echo $heading_title; ?></h3>
	</div>
	<div class="box-content">
		<div class="product-layout">
			<div class="box-featuredcarousel">
			<?php $f=0; foreach ($products as $product) { $f++ ?>
			<div>
				<div class="product-thumb transition">
				<div class="quick_info">
					<div id="quickview_featured_<?php echo $f?>">
						<div>
							<div class="left col-sm-4">
								...
								<div class="right col-sm-8">
									...
									<div class="cart-button">
										<button class="btn btn-add" type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i class="material-design-shopping232"></i></button>
					...
					<?php if ($product['special']) { ?><div class="sale"><?php echo $text_sale; ?></div><?php } ?>
					<div class="image">
					...
					<div class="cart-button">
						...
						<a class="quickview quickview-featured product-btn" data-toggle="tooltip" data-rel="details" href="#quickview_featured_<?php echo $f?>" title="<?php echo $text_quick; ?>">
